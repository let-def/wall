...
let font_sans = lazy (load_font "../example/Roboto-Regular.ttf")
  ...
  | Ok () ->
    ...
    (match
     ...
     | Error (`Msg e) ->
       ...
       exit 1
     | Ok w ->
       ignore (Sdl.gl_set_swap_interval 0);
       ...
       Sdl.log
         ...
         ow
         oh;
       let _sw = float ow /. float window_width
       and _sh = float oh /. float window_height in
          ...
          while not !quit do
            ...
            let () =
              ...
              let fps =
                ...
                I.stack
                  (I.paint
                     (Paint.color (Color.v 0.0 0.0 0.0 1.0))
                     Text.(
                       simple_text
                         ...
                         fps))
                  (I.paint
                     (Paint.color (Color.v 1.0 1.0 1.0 1.0))
                     Text.(
                       simple_text
            ...
            let seconds_elapsed =
              Int64.to_float (Int64.sub timing_end timing_start) /. Int64.to_float freq
            in
